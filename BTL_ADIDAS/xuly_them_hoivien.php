    <?php 
        ...
        if(!empty($_POST['mahoivien'])
            ...
            if($uploadOk == 0){
                ...
                $sql = "INSERT INTO `hoi_vien` (`avatar_path`, `ma_hoi_vien`, `ho_ten`, `so_dien_thoai`, `gioi_tinh`, `ngay_sinh`, `dia_chi`, `mat_khau`) VALUES ('$target_file', '$mahoivien', '$hoten','$sodt', '$gioitinh', '$ngaysinh', '$diachi', '$matkhau')";
