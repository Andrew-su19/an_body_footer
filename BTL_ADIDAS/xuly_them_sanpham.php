    <?php 
        ...
        if(!empty($_POST['tensanpham'])
            ...
            if($uploadOk == 0){
                ...
                $sql = "INSERT INTO `san_pham`(`avatar_path`, `ten_san_pham`, `ma_sp`, `mo_ta`, `don_gia`, `so_luong`, `mau_sac`) VALUES ('$target_file', '$tensanpham', '$masanpham', '$mota', '$dongia', '$soluong', '$mausac')";
